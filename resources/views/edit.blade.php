...
@section('content')
    <form method="POST" action="{{ route('article.update', $article) }}" class="h-min">
        @csrf
        @method('patch')
        <div class="container mx-auto py-8 h-full">
            <div class="max-w-3xl mx-auto bg-white rounded-lg shadow-md h-3/4">
                <div class="bg-white px-4 py-2">
                    <h1 class="text-3xl font-semibold text-gray-800 mb-8">Edit article</h1>
                    <!-- Post Title -->
                    <div>
                        <x-input-label for="title" />
                        <x-text-input id="title"
                            class="mt-1 w-full font-semibold text-gray-800 text-xl px-3 py-1 outline-none border-b-2"
                            type="input" name="title" :value="old('title', $article->title)" placeholder="Title of the post" autofocus />
                ...
                <div class="p-4 h-full">
                    ...
                    <div>
                        ...
                        <x-text-input id="image"
                            ...
                            type="input" name="image" :value="old('image', $article->image)" placeholder="Thumbnail's image URL" autofocus />
                    ...
                    <div class="h-full">
                        ...
                        <textarea id="text"
                            ...
                            type="text-area" name="text"" placeholder="Text of the article" autofocus>
